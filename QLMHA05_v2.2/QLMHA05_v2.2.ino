...
/*      Switch2 Pressed   */
      if (switchPin2State == HIGH && switch2PreviousState == LOW)
         {
      ...
      if (switchPin2State == LOW && switch2PreviousState == HIGH)
        {
...
/*      Switch3 Pressed     */
    if (switchPin3State == HIGH && switch3PreviousState == LOW) 
      {
    ...
    if (switchPin3State == LOW && switch3PreviousState == HIGH)
       {
...
/*      Switch4 Pressed     */
    if (switchPin4State == HIGH && switch4PreviousState == LOW) 
     {
    ...
    if (switchPin4State == LOW && switch4PreviousState == HIGH) {
...
/*      Switch5 Pressed   */    
    if (switchPin5State == HIGH && switch5PreviousState == LOW) {
    ...
    if (switchPin5State == LOW && switch5PreviousState == HIGH) {
...
String switchFeedback(String device1State,String device2State,String device3State,String device4State,String device5State)
{
...
void keepWiFiAlive(void * pvParameter){
   while(1)
   {
        if(WiFi.status() == WL_CONNECTED)
          {
        //    vTaskDelay(1000/ portTICK_PERIOD_MS);    // every 15 minutes  900000
            continue; 
          }
...
void handle_Status()
{
  server.send(200, "text/html", switchFeedback(device1State,device2State,device3State,device4State,device5State));
}
