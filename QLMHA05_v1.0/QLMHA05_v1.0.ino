/*
 changes :-
 1. removed jquery which used for updating the slider values.
 2. added slider without any script.
 */
...
void with_internet()
{
  ...
  char myData[7] = {
                        doc["device1"],doc["device2"],doc["device3"],doc["device4"],doc["device5"],doc["deviceId"],doc["sliderValue"]     // device1  && device2 && device3 && device4 && device5
                   };
  char schedule[11] =  {  
...
{    
 StaticJsonDocument<256> jsonDoc;
  ...
  vTaskDelay(600000 / portTICK_RATE_MS);      // publish the state every 10 minutes
}
